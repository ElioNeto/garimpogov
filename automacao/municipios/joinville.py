...
Portal: https://www.joinville.sc.gov.br/servicos/concursos-publicos/
"""
import logging
import re
...
class Joinville(DiarioMunicipal):
    ...
    search_url = "https://www.joinville.sc.gov.br/servicos/concursos-publicos/"
    ...
    def parse_html(self, html: str) -> list[dict]:
        ...
        links = (
            soup.find_all("a", href=re.compile(r"concurso|edital|processo.seletivo", re.I)) or
            soup.select("div.entry-content a") or
            soup.select("ul.list a")
        )
