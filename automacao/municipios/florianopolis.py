...
Portal de concursos: https://www.pmf.sc.gov.br/entidades/rh/index.php?cms=concursos+publicos
"""
import logging
import re
...
class Florianopolis(DiarioMunicipal):
    nome = "Prefeitura de Florianópolis"
    fonte = "PMF-SC"
    base_url = "https://www.pmf.sc.gov.br"
    search_url = "https://www.pmf.sc.gov.br/entidades/rh/index.php"

    def build_params(self, term: str, data_inicio: str, data_fim: str) -> dict:
        return {"cms": "concursos publicos"}
    ...
    def scrape(self) -> list[dict]:
        ...
        try:
            r = requests.get(self.search_url, params=self.build_params("", "", ""),
