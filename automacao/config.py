...
# ---------------------------------------------------------------------------
# B7: Configuração de modelos Gemini
# A diferença entre os modelos é INTENCIONAL:
# - GEMINI_EXTRACTION_MODEL: usado na ingestão (automacao/ai_extractor.py)
#   para extrair dados de HTML. Precisa ser rápido e barato -> gemini-2.0-flash-lite
# - GEMINI_CHAT_MODEL: usado no chat RAG (backend/app/services/rag.py)
#   para responder perguntas. Precisa de melhor qualidade -> gemini-1.5-flash
# Ambos usam o mesmo modelo de embedding: text-embedding-004
# ---------------------------------------------------------------------------
